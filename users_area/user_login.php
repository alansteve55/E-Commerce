...
<?php 
    if(isset($_POST['user_login'])){
        ...
        $select_query1="Select * from `user_table` where username='$user_username'";
        ...
        //cart item
        $select_query="Select * from `cart_deatils` where ip_address='$user_ip'";
        $result=mysqli_query($con,$select_query);
        $select_cart=mysqli_query($con,$select_query);
        $row_count_card=mysqli_num_rows($select_cart);
        if($row_count>0){
